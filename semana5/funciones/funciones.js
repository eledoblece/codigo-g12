...
/**
 * Esta funcion sirve para poder descifrar una moneda
 * @param {string} moneda 
 * @returns {string}
 */

const descifrarMoneda = (moneda) => {
...
console.log(descifrarMoneda("$"));

// arrow function inline
/**
 * Esta funcion sirve para calculara el area de un rectangulo
 * @param {number} base 
 * @param {number} altura 
 * @returns {number}
 */
